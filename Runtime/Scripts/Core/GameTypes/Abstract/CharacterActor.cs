...
namespace core.gameplay
{
    ...
    public abstract class CharacterActor : GameActor
    {
        ...
        public Dictionary<string, State<CharacterActor>> m_characterStates;
        protected AIStateMachine<CharacterActor> AIStateManager { get; set; }
        ...
        protected override void onStart()
        {
            ...
            AIStateManager = new AIStateMachine<CharacterActor>(this);
        ...
        private void FindAndCreateStates()
        {
            ...
            foreach (State<CharacterActor> _state in InstantiateStates<State<CharacterActor>>())
            {
        ...
        protected State<CharacterActor> GetStateByName(string _stateName)
        {
