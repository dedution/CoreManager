...
namespace core.modules
{
    public class InputManager
    {
        ...
        private static InputActionAsset m_GameActionAsset;
        ...
        private static void SetAssetConfiguration(InputActionAsset _asset, string _currentActionMap = "Player")
        {
        ...
        public static InputActionAsset LoadActionAssetConfiguration(string _asset, string _currentActionMap = "Player", bool useAsync = false)
        {
        ...
        public static void RestoreCurrentMap()
        {
            if (m_PlayerInput == null)
                return;
        ...
        public static void onActionHold(string _action, Action<InputAction.CallbackContext> _logicAction, string _map = "Player")
        {
            if (m_PlayerInput == null)
                return;
        ...
        public static void UnsubscribeToActionHold(string _action, Action<InputAction.CallbackContext> _logicAction, string _map = "Player")
        {
            if (m_PlayerInput == null)
                return;
        ...
        /* button was pressed */
        public static void onActionPressed(string _action, Action<InputAction.CallbackContext> _logicAction, string _map = "Player")
        {
            if (m_PlayerInput == null)
                return;
        ...
        /* button was released */
        public static void onActionReleased(string _action, Action<InputAction.CallbackContext> _logicAction, string _map = "Player")
        {
            if (m_PlayerInput == null)
                return;
        ...
        public static void UnsubscribeToActionPressed(string _action, Action<InputAction.CallbackContext> _logicAction, string _map = "Player")
        {
            if (m_PlayerInput == null)
                return;
        ...
        public static void UnsubscribeToActionReleased(string _action, Action<InputAction.CallbackContext> _logicAction, string _map = "Player")
        {
            if (m_PlayerInput == null)
                return;
        ...
        public static bool IsActionPressed(string _action, string _map = "Player")
        {
            if (m_PlayerInput == null)
                return false;
        ...
        public static bool IsActionReleased(string _action, string _map = "Player")
        {
            if (m_PlayerInput == null)
                return false;
        ...
        public static bool IsActionPressedThisFrame(string _action, string _map = "Player")
        {
            if (m_PlayerInput == null)
                return false;
        ...
        public static T ReadActionValue<T>(string _action, bool checkReleased = false, string _map = "Player", T _default = default(T)) where T : struct
        {
            if (m_PlayerInput == null)
                return default;
